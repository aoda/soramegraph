...
public class Autocomplete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		aaatxt.logic.Autocomplete a = new aaatxt.logic.Autocomplete();
		String result = a.searchStart((q != null ? q : ""));
		req.setAttribute("result", result);
		req.getRequestDispatcher("/WEB-INF/jsp/autocomplete.jsp").forward(req, resp);
	}
